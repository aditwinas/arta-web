        ...
        <div className="flex flex-col lg:flex-row items-center gap-20">
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="p-12 bg-primary-container rounded-3xl text-white shadow-2xl relative overflow-hidden">
              ...
              <div className="flex items-baseline gap-4 mb-8">
                <span className="text-7xl font-black">18%</span>
                <span className="text-xl text-on-primary-container">Imbal Hasil Tahunan Tetap</span>
              </div>
              <div className="space-y-6 mb-10">
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                  <span className="font-medium text-slate-300">Pembayaran Bulanan</span>
                  <span className="font-bold text-secondary-container">1.5% Tetap</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                  <span className="font-medium text-slate-300">Modal Minimum</span>
                  <span className="font-bold text-white">Rp 500 Juta / Lot</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg border border-white/10">
                  <span className="font-medium text-slate-300">Tenor Kontrak</span>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
              ...
              <div className="p-6 bg-secondary-container/20 rounded-xl border border-secondary/20">
